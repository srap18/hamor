...
export const ELITE_VIP_TIERS: EliteVipTier[] = [
  {
    ...
    perks: [
      ...
      "🛒 خصم متجر 5%",
      "💎 50 جوهرة يومياً",
      "💰 كاش باك 5% جواهر على أي شراء بالجواهر",
      "🚀 الحد اليومي للصواريخ 100 بدل 30",
  ...
  },
  {
    ...
    perks: [
      ...
      "🛒 خصم متجر 10%",
      "💎 120 جوهرة يومياً",
      "💰 كاش باك 10% جواهر على أي شراء بالجواهر",
      "🛡️ شارة الدرع الفضي",
    ],
  },
  {
    ...
    perks: [
      ...
      "🛒 خصم متجر 15%",
      "💎 250 جوهرة يومياً",
      "💰 كاش باك 15% جواهر على أي شراء بالجواهر",
      "👑 شارة التاج الذهبي",
  ...
  },
  {
    ...
    perks: [
      ...
      "🛒 خصم متجر 20%",
      "💎 450 جوهرة يومياً",
      "💰 كاش باك 20% جواهر على أي شراء بالجواهر",
  ...
  },
  {
    ...
    perks: [
      ...
      "🛒 خصم متجر 30%",
      "💎 800 جوهرة يومياً",
      "💰 كاش باك 30% جواهر على أي شراء بالجواهر",
  ...
  },
  {
    ...
    perks: [
      ...
      "🚀 شراء الأسلحة والصواريخ بلا حد يومي نهائياً",
      "🛡️ تفعيل الدروع فوراً بدون انتظار 7 أيام",
      "🤝 مقايضة مجانية بدون رسوم 50 جوهرة",
      "✏️ تغيير الاسم كل 3 أيام بدل 14 يوم",
      "💰 كاش باك 35% جواهر على أي شراء بالجواهر + ترقيات الأسواق",
