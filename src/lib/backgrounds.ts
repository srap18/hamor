...
import marketVillageBg from "@/assets/bg-joyboy.jpg.asset.json";
import marketVillageBurnedBg from "@/assets/bg-joyboy-burned.jpg.asset.json";
import marketVillageVideo from "@/assets/bg-joyboy.mp4.asset.json";
import marketVillageBurnedVideo from "@/assets/bg-joyboy-burned.mp4.asset.json";
...
const UNIFIED_SHIP_SLOTS = [
  { top: 52, left: 62, scale: 1 },
  { top: 66, left: 60, scale: 1 },
  { top: 80, left: 62, scale: 1 },
] as const;
...
export const BACKGROUNDS: SceneBg[] = [
  ...
  },
  {
    ...
    rarity: "legendary",
    image: hilalBg.url,
    burnedImage: hilalBurnedBg.url,
    video: hilalVideo.url,
    burnedVideo: hilalBurnedVideo.url,
    animated: true,
    objectPosition: "center center",
    seaSide: "right",
    waterTop: 46,
