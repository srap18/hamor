...
export const STORE_PACKS: StorePack[] = [
  ...
  // ───── Golden Fisher (premium recharge-only) ────────────────
  {
    ...
    tag: "ذهبي حصري",
    popular: true,
    description: "طاقمان من الصياد الذهبي — كل واحد يفعّل لمدة 24 ساعة كاملة:\n• صيد تلقائي على سفنك الثلاث في نفس الوقت، كل سفينة على حسب وقت امتلائها الأصلي (بدون تسريع).\n• السيرفر يفحص كل سفينة كل 30 ثانية، وأي سفينة تمتلئ يتم حصدها فوراً وإعادة إطلاقها للصيد بدون انتظار باقي السفن.\n• يشتغل وأنت أون لاين أو أوف لاين بنفس الكفاءة — لا يتوقف لو سكّرت اللعبة.\n• يتجاوز الحد الأقصى لمخزون السمك طوال فترة التفعيل، السمك يتراكم بدون سقف.\n• حصانة كاملة من الهجوم والسرقة على حسابك وسفنك وسمكك طوال الـ24 ساعة.\n• لو فعّلت طاقم ثاني والأول لسه شغّال، الوقت يتراكم فوق المتبقي.\n\nمتوفر فقط عبر الشحن — لا يُشترى بالذهب أو الجواهر.",
    reward: {
