...
const SHIP_DATA: Record<number, ShipOverride> = {
  ...
  28: { ar: "سفينة ملك المحيط",        rarity: "Mythic",    flavor: "سفينة ملك المحيط بلا منازع.",                         storage: 220000, price: 2800000000,  fishingMinutes: 52,   fishPool: ["poseidon","kraken","leviathan"] },
  29: { ar: "سفينة التنين البحري",     rarity: "Mythic",    flavor: "تنين بحري ينفث الرعب في الأمواج.",                    storage: 260000, price: 7000000000,  fishingMinutes: 57,   fishPool: ["black_pearl","megalodon","sea_dragon"] },
  30: { ar: "سفينة نهاية الأعماق",     rarity: "Mythic",    flavor: "السفينة النهائية: نهاية كل الأعماق.",                 storage: 300000, price: 12600000000, fishingMinutes: 60,   fishPool: ["golden_koi","poseidon","black_pearl","kraken"] },
