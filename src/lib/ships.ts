...
const SHIP_DATA: Record<number, ShipOverride> = {
  ...
  26: { ar: "سفينة أسد الأعماق",       rarity: "Mythic",    flavor: "سفينة الأسد المرعبة بقوة لا تُقهر.",                  storage: 165000, price: 800000000,   fishingMinutes: 45,   fishPool: ["kraken","leviathan","goldfish","abyss_titan"] },
  27: { ar: "سفينة التيتانيوم البحري", rarity: "Mythic",    flavor: "سفينة تيتانيوم لا يخترقها شيء.",                      storage: 190000, price: 1000000000,  fishingMinutes: 49,   fishPool: ["megalodon","sea_dragon","pearl","abyss_titan"] },
  28: { ar: "سفينة ملك المحيط",        rarity: "Mythic",    flavor: "سفينة ملك المحيط بلا منازع.",                         storage: 220000, price: 3640000000,  fishingMinutes: 52,   fishPool: ["poseidon","kraken","leviathan","abyss_titan"] },
  29: { ar: "سفينة التنين البحري",     rarity: "Mythic",    flavor: "تنين بحري ينفث الرعب في الأمواج.",                    storage: 260000, price: 9100000000,  fishingMinutes: 57,   fishPool: ["black_pearl","megalodon","sea_dragon","abyss_titan"] },
  30: { ar: "سفينة نهاية الأعماق",     rarity: "Mythic",    flavor: "السفينة النهائية: نهاية كل الأعماق.",                 storage: 300000, price: 16380000000, fishingMinutes: 60,   fishPool: ["golden_koi","poseidon","black_pearl","kraken","abyss_titan"] },
  ...
  32: { ar: "الغواصة الملكية VIP",     rarity: "Mythic",    flavor: "غواصة سوداء فاخرة حصرية لأعضاء VIP 5 فأعلى — تصيد الأروانا الفضية وشبح المرجان النادرَين.", storage: 350000, price: 0,           fishingMinutes: 45,   fishPool: ["silver_arowana","coral_phantom"] },
