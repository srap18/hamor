...
const SHIP_DATA: Record<number, ShipOverride> = {
  ...
  30: { ar: "سفينة نهاية الأعماق",     rarity: "Mythic",    flavor: "السفينة النهائية: نهاية كل الأعماق.",                 storage: 300000, price: 16380000000, fishingMinutes: 60,   fishPool: ["golden_koi","poseidon","black_pearl","kraken"] },
