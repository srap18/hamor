              ...
              {OUTFITS.map((o) => {
                ...
                return (
                  <button
                    ...
                    title={o.name}
                  >
                    <img decoding="async" src={o.img} alt={`زي ${o.name}`} className="w-full h-16 object-contain" />
                  ...
                  return (
                    ...
                    >
                      <button onClick={() => addOne(f.fish_id)} className="w-full flex items-center justify-center">
                        {fish?.img ? (
                          <img decoding="async" src={fish.img} alt={`سمكة ${fish.name}`} className="w-10 h-10 object-contain drop-shadow"/>
                        ) : (
