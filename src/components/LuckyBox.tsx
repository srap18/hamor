  ...
  return (
    <>
      <button
        ...
        className="fixed left-3 bottom-28 z-[60] w-12 h-14 rounded-xl flex flex-col items-center justify-center active:scale-95"
        style={{
          color: "#2a1605",
      ...
      >
        <span
          className="pointer-events-none absolute inset-x-2 top-1 h-1/2 rounded-lg opacity-60"
