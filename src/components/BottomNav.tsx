...
export function BottomNav({ active }: { active?: string }) {
  ...
  return (
    <>
      <div className="absolute bottom-0 left-0 right-0 z-30 px-2 pt-2 border-t-4 border-amber-400/80 bg-gradient-to-b from-[#2a1606] via-[#1a0d04] to-black shadow-[0_-6px_20px_rgba(0,0,0,0.7)]" style={{ paddingBottom: "max(0.5rem, env(safe-area-inset-bottom))" }}>
