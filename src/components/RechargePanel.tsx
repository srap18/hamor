                    ...
                    <div className="flex flex-wrap gap-1">
                      ...
                      {r.items?.map((it) => {
                        const labels: Record<string, string> = {
                          ...
                          anti_rocket: "🛡️ مضاد الصواريخ",
                          anti_nuke: "🛡️ مضاد القنبلة الذرية",
                          anti_ad_bomb: "🛡️ مضاد القنبلة الإعلانية",
                          disabler_rocket: "⚡ تعطيل مضاد الصواريخ",
                          disabler_nuke: "⚡ تعطيل مضاد الذري",
                          disabler_ad_bomb: "⚡ تعطيل مضاد الإعلانية",
                          af_phoenix: "🖼️ إطار العنقاء",
                          nf_phoenix: "🏷️ لوحة اسم العنقاء",
                          bf_phoenix: "💬 فقاعة العنقاء",
                          pf_phoenix: "🪪 بطاقة العنقاء",
                          af_leo: "🖼️ إطار الأسد",
                          nf_leo: "🏷️ لوحة اسم الأسد",
                          bf_leo: "💬 فقاعة الأسد",
                          pf_leo: "🪪 بطاقة الأسد",
                          af_scorpio: "🖼️ إطار العقرب",
                          nf_scorpio: "🏷️ لوحة اسم العقرب",
                          bf_scorpio: "💬 فقاعة العقرب",
                          pf_scorpio: "🪪 بطاقة العقرب",
                          af_pisces: "🖼️ إطار الحوت",
                          nf_pisces: "🏷️ لوحة اسم الحوت",
                          bf_pisces: "💬 فقاعة الحوت",
                          pf_pisces: "🪪 بطاقة الحوت",
                        };
