...
function ProfilePage() {
  ...
  return (
    <div className="fixed inset-0 overflow-y-auto text-foreground" dir="rtl"
      ...
      <header className="sticky top-0 z-20 glass-hud border-b border-accent/30 px-3 pb-3 flex items-center gap-3" style={{ paddingTop: "max(0.75rem, var(--sa-top))" }}>
      ...
      <main className="p-3 pb-10 space-y-4">
        ...
        {userId && <SeasonAchievements userId={userId} />}
      </main>
