    ...
    handlers: {
      GET: async () => {
        const entries = [
          ...
          { path: "/battle", changefreq: "weekly", priority: "0.6" },
          { path: "/cosmetics", changefreq: "weekly", priority: "0.5" },
          { path: "/inventory", changefreq: "weekly", priority: "0.5" },
          { path: "/invite", changefreq: "monthly", priority: "0.4" },
          { path: "/forgot-password", changefreq: "monthly", priority: "0.3" },
          { path: "/reset-password", changefreq: "monthly", priority: "0.3" },
          { path: "/my-vip", changefreq: "weekly", priority: "0.5" },
          { path: "/payment-success", changefreq: "monthly", priority: "0.3" },
          { path: "/profile", changefreq: "weekly", priority: "0.5" },
          { path: "/recharge", changefreq: "weekly", priority: "0.6" },
          { path: "/guide/legacy-players", changefreq: "monthly", priority: "0.7" },
        ];
