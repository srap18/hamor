...
const PROTECTION: Item[] = [
  ...
  { id: "anti_kraken", name: "مضاد قنبلة الكراكن", emoji: "🐙", price: 10000, currency: "gem", desc: "استخدام واحد • نسبة صد 100% لنهب مخزن سمكك", rarity: "legendary" },
  { id: "disabler_kraken", name: "معطّل مضاد الكراكن", emoji: "⚡", price: 10000, currency: "gem", desc: "يعطّل مضاد الكراكن لدى الخصم 10 دقائق", rarity: "legendary" },
];
