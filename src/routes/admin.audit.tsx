...
const ACTION_AR: Record<string, string> = {
  ...
  admin_block_login: "🚫 حظر دخول",
  admin_edit_bio: "✏️ تعديل النبذة",
  admin_edit_user: "✏️ تعديل لاعب",
  admin_give_code: "🎟️ إعطاء كود لشخص",
  admin_give_code_to_all: "🎁 إعطاء كود للجميع",
  admin_redeem_code_for: "🎟️ استبدال كود لشخص",
  admin_set_inventory_quantity: "📦 تعديل كمية مخزون",
  admin_set_market_levels: "🏪 تعديل مستويات السوق",
  admin_set_player_fish: "🐟 تعديل سمك اللاعب",
  admin_set_player_full: "🛠️ تعديل كامل للاعب",
  admin_set_username: "🪪 تغيير اسم المستخدم",
  admin_unblock_login: "✅ فك حظر الدخول",
  admin_wipe_profile: "🧨 مسح حساب لاعب",
  ban_user: "🔨 حظر لاعب",
  broadcast: "📣 بث إذاعي",
  delete_user_messages: "🗑️ حذف رسائل لاعب",
  edit_player: "✏️ تعديل لاعب",
  grant_code_to_online: "🎁 إعطاء كود للمتصلين",
  mute_user: "🔇 كتم لاعب",
  unban_user: "🔓 فك حظر",
  unmute_user: "🔊 فك كتم",
  weekly_xp_distribute_now: "🏆 توزيع جوائز XP",
};
