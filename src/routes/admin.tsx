...
const NAV: Array<{ to: string; label: string; icon: string; exact?: boolean }> = [
  ...
  { to: "/admin/fleet-combos", label: "خلطات السفن", icon: "🌟" },
  ...
  { to: "/admin/event-points", label: "تعديل نقاط الفعاليات", icon: "⚖️" },
...
function AdminLayout() {
  ...
  return (
    <div dir="rtl" className="h-full min-h-screen overflow-hidden flex flex-col md:flex-row bg-slate-950 text-slate-100">
      {/* Sidebar / Topbar */}
      <aside
