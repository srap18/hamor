...
function Index() {
  ...
  return (
    ...
    >
      ...
      {/* Ship Market — in-world building anchored on the right over the water.
          Visual evolves with the user's market level (1-30). Burns when nuked. */}
      <ShipMarketBuilding
        level={marketLevel}
      ...
      <Link
        to="/ship-market"
        onClick={() => sound.play("click")}
        className="absolute right-2 top-[52%] z-30 w-14 h-16 rounded-2xl border-2 border-amber-300 bg-gradient-to-b from-[#3a1f0a] via-[#5a2e0e] to-[#1a0d04] shadow-[0_4px_14px_rgba(0,0,0,0.6),0_0_18px_rgba(252,191,73,0.4)] flex flex-col items-center justify-center text-amber-100 active:scale-95"
      >
