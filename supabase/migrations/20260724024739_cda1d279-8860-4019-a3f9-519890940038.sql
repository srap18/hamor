...
BEGIN
  ...
  -- Any public/multi-use code (max_uses > 1 or unlimited = 0) can be redeemed once per account
  -- regardless of shared devices — so new codes distributed publicly never hit this problem.
