...
BEGIN
  ...
  -- Base = time-based fill toward this trip's ship capacity.
  -- We intentionally do NOT subtract leftover unsold fish from prior trips,
  -- so the on-screen counter (which is time-based) always matches the reward.
