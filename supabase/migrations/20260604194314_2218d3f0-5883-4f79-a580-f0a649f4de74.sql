...
BEGIN
  ...
  -- Luck doubles the catch. The bonus is allowed to exceed ship storage
  -- (the crew "finds" extra fish), but the player's total market capacity
  -- still applies as the hard cap.
