...
BEGIN
  ...
  -- 🔥 خصم 30% دائم على إطارات البروفايل (الصورة/الاسم/الفقاعة/البطاقة)
  IF _item_type IN ('frame','name_frame','bubble_frame','profile_frame') THEN
    _total := GREATEST(1, CEIL(_total * 0.70))::bigint;
  END IF;
