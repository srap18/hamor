...
AS $$
  SELECT
    (CASE
      WHEN _level = 26 THEN 5000000000::bigint
      WHEN _level = 27 THEN 10000000000::bigint
      WHEN _level = 28 THEN 20000000000::bigint
      WHEN _level = 29 THEN 40000000000::bigint
      ELSE (50000 * power(1.8, GREATEST(_level, 1) - 1))::bigint
    END) AS cost_coins,
    (CASE
...
AS $$
  SELECT
    ...
    CASE
      ...
      WHEN _level <= 29 THEN 86400
      WHEN _level = 30  THEN 172800
      ELSE 259200
    END;
$$;