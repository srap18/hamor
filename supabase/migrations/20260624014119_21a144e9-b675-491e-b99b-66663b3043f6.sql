...
BEGIN
  ...
  -- Cancel incoming steal missions that slipped in before sync.
  ...
  -- FIX: Auto-restart fishing for any of this user's eligible ships that
  -- got stopped (e.g. after collecting full catch, or after a transient bug).
  -- Only restarts ships that are NOT on a steal mission and NOT damaged.
  UPDATE public.ships_owned
     SET at_sea = true,
