...
-- Fix: ticker "آخر هجوم" wasn't updating because launch_nuke / launch_ad_bomb
-- never called stamp_global_last_attack. Add the stamp at the end of the
-- successful branch of each function so the global ticker shows the latest
-- attacker/target across all players.
