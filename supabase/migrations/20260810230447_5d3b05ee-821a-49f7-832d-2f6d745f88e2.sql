...
BEGIN
  ...
  IF public.elite_vip6_active(v_user) THEN v_purchase_limit := 45; END IF;
...
REVOKE ALL ON FUNCTION public.daily_rockets_status() FROM PUBLIC, anon;
GRANT EXECUTE ON FUNCTION public.daily_rockets_status() TO authenticated, service_role;