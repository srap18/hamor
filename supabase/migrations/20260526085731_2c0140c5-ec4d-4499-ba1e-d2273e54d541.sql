...
BEGIN
  ...
  -- Repair time: minimum 4 hours so destruction is meaningful, scales up with ship level.
  -- tpl 1 -> 4h, tpl 5 -> 4.2h, tpl 10 -> 16.7h, capped at 72h.
  _repair_secs := LEAST(259200, GREATEST(14400, _tpl * _tpl * 600));

  -- If previous repair already expired, auto-heal so a fresh destruction cycle can record cleanly.
