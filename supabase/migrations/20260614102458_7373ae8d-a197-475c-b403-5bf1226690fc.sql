...
BEGIN
  ...
  -- Client-visible bar cap: the player should never receive MORE than what
  -- the on-screen progress bar showed at the moment of collection. Clients
  -- can only LOWER the value (safe — they can't cheat upwards).
