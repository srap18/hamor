...
-- Add "death banner" columns to profiles: who last destroyed me with a nuke or ad-bomb.
ALTER TABLE public.profiles
  ADD COLUMN IF NOT EXISTS last_destroyer_id uuid,
  ADD COLUMN IF NOT EXISTS last_destroyer_name text,
  ADD COLUMN IF NOT EXISTS last_destroyer_kind text,
  ADD COLUMN IF NOT EXISTS last_destroyer_at timestamptz;

-- Update launch_ad_bomb to stamp the target's death banner.
...
-- Update broadcast_nuke to also stamp the death banner.
