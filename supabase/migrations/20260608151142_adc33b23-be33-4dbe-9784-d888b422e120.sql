...
BEGIN
  ...
  -- Always guarantee at least 1 fish on any collect (even immediate stop).
  IF _base <= 0 THEN
    _base := 1;
  END IF;
  ...
  -- Respect market cap, but always allow at least 1 fish through when market_remaining > 0.
