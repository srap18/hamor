...
VALUES
  (
    'phoenix',
    'سفينة العنقاء التنينية',
    'سفينة العنقاء الحمراء — حصرية للمتجر، تصيد عنقاء النار النادرة فقط.',
    31,
    'Legendary',
    13000,
    80,
  ...
  (
    'submarine',
    'الغواصة الملكية VIP',
    'غواصة VIP حصرية تصيد تيتان الأعماق النادر.',
    32,
    'Mythic',
    350000,
    150,
...
UPDATE public.ship_catalog
SET fish_pool = '["abyss_titan"]'::jsonb,
    storage = 350000,
