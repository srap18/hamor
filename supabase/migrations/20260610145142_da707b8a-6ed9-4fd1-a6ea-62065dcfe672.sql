...
-- 1) Recreate golden_fisher_tick without recording catches into competitions
  ...
  LOOP
    ...
    IF _market_remaining > 0 THEN
      ...
      IF _qty > 0 THEN
        ...
        -- NOTE: Golden fisher catches do NOT count toward fishing competitions.
...
-- 2) New RPC to remove/deactivate the Golden Fisher for the calling user
