DROP FUNCTION IF EXISTS public.admin_top_inventory_holders(text, text, integer);
CREATE FUNCTION public.admin_top_inventory_holders(_item_type text DEFAULT NULL, _item_id text DEFAULT NULL, _limit integer DEFAULT 100)
