...
-- Patch apply_ship_damage_v2 to also publish a global banner when blocked
...
BEGIN
  ...
  IF _blocked THEN
    ...
    -- Global banner visible to everyone
...
-- Patch launch_nuke to publish global banner on block
...
-- Patch launch_ad_bomb to publish global banner on block
