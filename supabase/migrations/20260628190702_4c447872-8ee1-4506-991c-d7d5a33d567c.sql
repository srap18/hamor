...
BEGIN
  ...
  -- Per-ship preferred fish always wins (survives guide expiry).
  ...
  -- Pick the requested fish if a guide is active and the request is valid;
  -- otherwise honor the saved per-ship preference (even without a guide);
