...
-- Drop old single-ship function
DROP FUNCTION IF EXISTS public.buy_phoenix_ship();

-- Pack of 3 phoenix ships for 3800 gems
...
BEGIN
  ...
  FOR i IN 1..3 LOOP
    ...
    VALUES (uid, 31, 13000, 13000, false, 'phoenix')
...
-- Single phoenix ship for 1500 gems
