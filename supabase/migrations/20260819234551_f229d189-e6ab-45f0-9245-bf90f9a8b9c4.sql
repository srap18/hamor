...
BEGIN
  ...
  _duration_days := CASE
    WHEN _bg_id = 'worldcup' THEN NULL
    WHEN _bg_id = 'dragon_hoard' THEN 30
    ELSE 7
  END;
  ...
  IF _has_row THEN
    ...
    END IF;
  ELSE
    INSERT INTO public.inventory(user_id, item_type, item_id, quantity, acquired_at, meta)
    VALUES (
