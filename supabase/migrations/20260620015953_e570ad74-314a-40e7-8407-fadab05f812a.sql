...
BEGIN
  ...
  -- Tribes — if user owns a tribe, dissolve membership refs; null owner to avoid orphan FK
...
REVOKE ALL ON FUNCTION public.admin_hard_delete_user(uuid) FROM PUBLIC, anon;
